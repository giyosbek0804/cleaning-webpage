  ...
  summary.addEventListener("click", () => {
    if (content.style.maxHeight) {
      ...
      if (text.includes("regular cleaning")) {
        ...
        armImg.style.backgroundImage = "url('/public/images/arm.webp')";
      } else if (text.includes("deep cleaning")) {

        armImg.style.backgroundImage = "url('/public/images/red-instrument2.webp')";
      } else if (text.includes("move in-out cleaning")) {

        armImg.style.backgroundImage = "url('/public/images/purple-arm.webp')";
      }
    }
  })
